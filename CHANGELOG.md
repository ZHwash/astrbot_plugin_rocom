...
- **Wiki 百科详细说明文档**：在 README 中补充 Wiki 功能的查询方式、高级查询、配置项等完整说明
- **项目结构文档完善**：在 README 中添加 `wiki/` 目录的完整结构说明

### Changed

- **文档合并策略**：以 pr0.4 文档为蓝本，保留所有原有内容，仅添加 upstream/master 新增的家园功能相关内容
- **Wiki 功能状态更新**：将 Wiki 从"暂不可用"改为正常功能介绍，保留完整的离线数据库查询能力
- **README 特性一览优化**：将 Wiki 功能从警告状态改为正面功能介绍

### Merged

- **分支合并**：成功将 pr0.4 的 Wiki 功能合并到基于 upstream/master 的 pr0.5 分支
- **文档同步**：完整保留 pr0.4 的 Wiki 文档，同时融合 upstream/master 的家园功能文档
- **代码整合**：pr0.5 现在同时包含最新的家园功能和完整的 Wiki 功能
